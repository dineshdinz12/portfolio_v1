...
const StackIcon = ({ name, icon }: { name: string; icon: string }) => {
    const [hasError, setHasError] = useState(false);

    if (hasError) {
        return (
            <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 text-primary font-bold text-sm shrink-0">
